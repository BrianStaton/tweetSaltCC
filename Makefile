...
DEP_DEBUG = 
OUT_DEBUG = bin/Debug/tweetSaltCC
...
$(OBJDIR_DEBUG)/tweetSaltCC.o: tweetSaltCC.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c tweetSaltCC.cpp -o $(OBJDIR_DEBUG)/tweetSaltCC.o

$(OBJDIR_DEBUG)/tweetnacl.o: tweetnacl.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c tweetnacl.cpp -o $(OBJDIR_DEBUG)/tweetnacl.o
...
$(OBJDIR_RELEASE)/tweetSaltCC.o: tweetSaltCC.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c tweetSaltCC.cpp -o $(OBJDIR_RELEASE)/tweetSaltCC.o

$(OBJDIR_RELEASE)/tweetnacl.o: tweetnacl.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c tweetnacl.cpp -o $(OBJDIR_RELEASE)/tweetnacl.o
